...
// identity（证同） is an extensions: it is not part of the standard.
template <class _Tp>
...
// select1st and select2nd（选择） are extensions: they are not part of the standard.
...
// project1st and project2nd（投射） are extensions: they are not part of the standard
