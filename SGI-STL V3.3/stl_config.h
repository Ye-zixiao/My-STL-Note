...
/* 1、检测编译器对C++语言特性的支持，生成一些标记宏（类似于功能特性测试宏
    ），以方便后续在不同平台上采取不同的程序编写策略，提高可移植性   */
...
/* 2、根据上面产生的标记宏，做出一些弥补替代定义，例如bool定义缺失
    下的补足；以及再定义一些常用的宏/函数宏来帮助后续程序的编写    */
...
#   define typename     //这里若缺typename应该定义#define typename class🧐
# endif
